...
color_map = {"\\textsc{DynamicCache}": "green", "Baseline-1": "indigo", "Baseline-5": "blue", "Lookup": "blue",
             "Insertion": "red"}
hatch_map = {"\\textsc{DynamicCache}": "+++", "Baseline-1": "xxxx", "Baseline-5": "////", "Lookup": "////",
             "Insertion": "...."}
...
def plot(**kwargs):
    ...
    fig.subplots_adjust(left=0.2, top=0.85, right=0.96, bottom=0.20)
    ...
    if not kwargs.get('nolegend', False):
        ...
        if legend_pos == 'upper-left':
            ...
            plt.legend(loc='upper center', bbox_to_anchor=(0.45, 1.25), fontsize='small')
        else:
